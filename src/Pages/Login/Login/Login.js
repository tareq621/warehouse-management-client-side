...
const Login = () => {
    ...
    return (
        <div className='container col-12 col-sm-12 col-md-6'>
            <h1 style={{ color: '#E21717' }} className='text-center fw-bold mt-3'>Log in to your account</h1>
            <Form onSubmit={handleLogin} className=' from-container my-5 p-5 rounded'>
                ...
                <div className='my-3'>
                    ...
                    <p>Don't have an account? <Link to="/signup" className='section-title text-decoration-none pe-auto' onClick={navigateSignUp}>Sign Up</Link></p>
                </div>
